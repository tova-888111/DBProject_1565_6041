...
נוספו אילוצים לבסיס הנתונים כדי להבטיח תקינות נתונים:

- מניעת ערכים שליליים (כגון שכר או כמות מלאי)  
- הגבלת ערכים לטווחים תקינים (כגון אחוזי הנחה)  
- שמירה על עקביות הנתונים  

האילוצים מונעים הכנסת נתונים שגויים למערכת.
