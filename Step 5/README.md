...
### 📺 סרטון הצגת תכלית של המערכת
להורדה וצפייה בהקלטת מסך מלאה של פעולת האפליקציה והממשק:

https://github.com/user-attachments/assets/2142e82f-55dd-4d3d-9d33-5a8bf60847c9
...
## **הוראות הפעלה כלליות:** 
המערכת מנוהלת באמצעות לשוניות, כאשר לשונית "לוח בקרה רשתי" מציגה מדדים וגרפים המתעדכנים אוטומטית, ושאר הלשוניות מנהלות את ישויות המלאי, המחסנים, העובדים, הספקים וההזמנות. בכל המסכים, הקלדה בשדות הסינון העליונים תסנן את השורות בטבלה באופן דינמי בזמן אמת. להוספת רשומה חדשה לחץ על הכפתור הירוק בראש הלשונית, או סמן שורה בטבלה ולחץ על כפתורי העריכה והמחיקה בתחתית (פעולות מחיקה ייחסמו מאובטחת אם קיימות תלויות בבסיס הנתונים). 

בלשונית הזמנות קיימים כפתורים מיוחדים:
* לחץ על **"📦 ניהול ועדכון תכולת הזמנה"** כדי להוסיף או להסיר מוצרים מתוך ההזמנה.
* לחץ על **"⚡ חישוב עלות סיטונאית"** כדי לעדכן את מחיר הרכש של ההזמנה לפי אחוז עלות מספק.
* לחץ על **"✅ השלמת הזמנה וקליטת מלאי"** כדי להריץ פרוצדורת שרת שסוגרת את ההזמנה ומסנכרנת אוטומטית את כמויות המלאי על מדפי הסניף.

בלשוניות המלאי ומוצרים  ומחסנים לוגיסטיים קיימים כפתורי ניהול קשרים ייעודיים:
* לחץ על **"📜 ניהול כשרויות המוצר"** (בלשונית מלאי) לאחר סימון פריט בקטלוג כדי להוסיף או להסיר כשרויות המאושרות למוצר זה.
* לחץ על **"📜 צפייה במנהלים"** (בלשונית מחסנים) לאחר סימון מחסן בטבלה כדי לפתוח חלון ייעודי המנהל ומציג את העובדים האחראיים על ניהול אותו מחסן.
